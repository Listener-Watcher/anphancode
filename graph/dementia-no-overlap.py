...
def run_caueeg_linkx_mil(
    ...
    with open(log_path, "w") as f:
        ...
        f.write(f"use_center_loss {use_center_loss}\n")
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(root_path,'result_MIL-LinkX-dementia-no-overlap')
    ...
    run_name = (
        ...
        f"{args.connectivity_metric}_{k_tag}_{center_loss}_{args.encoder_type}_{args.mil_pool_type}_{args.topology}"
    )
