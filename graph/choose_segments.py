...
def run_caueeg_linkx_mil_entropy(
    dataset_path,
    fixed_edges,          
    channel_names,
    task="abnormal",
    ...
    with open(log_path, "w") as f:
        ...
        f.write(f"dropout={dropout}, use_lr_scheduler={use_lr_scheduler}\n")
    ...
    try:
        segment_to_cluster = _build_segment_to_cluster_lookup(manifest_df)
        log_selection_diversity_over_epochs(
            train_dataset,
            save_dir=os.path.join(run_dir, "selection_diversity"),
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(root_path,'result-choosesegment-check')
    ...
    run_name = (
        ...
        f"{args.connectivity_metric}_{k_tag}_{args.encoder_type}_{args.mil_pool_type}_{args.topology}"
    )
