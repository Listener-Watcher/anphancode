...
def run_caueeg_linkx_mil(
    ...
    if train_dataset_mode == "label_aware_random":
        train_dataset = LabelAwareSubjectBagDataset(
            ...
            # base_k=base_k,
            base_k=None,
            k_by_label={label: base_k for label in range(num_classes)},
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(root_path,'result-paper')
    ...
    parser.add_argument("--cluster_col", type=str, default="kmeans_cluster_id")
    ...
    if segment_selection_strategy.startswith("global_cluster"):
        cleancluster_manifest_path = "/home/anphan/Documents/CAUEEG/visualize-random/global_segment_clusters/global_cluster_manifest.csv"
    else:
