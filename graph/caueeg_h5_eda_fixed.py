...
def run_caueeg_h5_eda(
    ...
    *,
    ...
    plot3_path = None
    if example_channel_feature is not None:
...
def main() -> None:
    ...
    parser.add_argument("--example_channel_feature", type=str, default=None, help="Feature key for Plot 3, e.g. relative_band_power__rbp_beta.")
