...
from mil_full_std import select_label_aligned_greedy_graphs_from_manifest, load_h5_payload_for_subjects, SubjectMILClassifier, fit_mil_baseline
...
def run_caueeg_linkx_mil(
    ...
    elif selection_strategy == "label_aligned_greedy_k":
        train_graphs_selected = select_label_aligned_greedy_graphs_from_manifest(
            train_graphs,
            manifest_df,
            k=base_k,
            seed=seed,
            cluster_col="global_cluster_id",
            label_col=None,          # auto-detect; or set "label" / "class_label"
            only_clean=False,        # first basic version: use all matched segments
            debug_dir=os.path.join(run_dir, "label_aligned_greedy_debug"),
        )
        train_dataset_mode = "fixed_all_selected"    
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(root_path,'result-bag_aug_mode-check')
    ...
    parser.add_argument("--segment_selection_strategy", type=str, default="original_random_k", 
        choices=["label_aligned_greedy_k", "original_random_k", "global_cluster_random_k", "global_cluster_proportional_random_k", 
