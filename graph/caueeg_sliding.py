...
def run_caueeg_linkx_mil(
    ...
    run_name = f"{timestamp}_{task}_linkxmil_{connectivity_metric}_k{base_k}_{encoder_type}_{mil_pool_type}_{filter_method}"
    ...
    train_ids_suf = train_ids_filter
    val_ids_suf = val_ids_filter
    test_ids_suf = test_ids_filter
    ...
    if encoder_type not in ["linkx_cnn5", "cnn5"]:

        # train_graphs = payload_to_graphs(
        #     payload, train_ids_suf,
        #     feature_families=feature_families,
        #     connectivity_metric=connectivity_metric,
        #     connectivity_band=connectivity_band,
        # )
        # val_graphs = payload_to_graphs(
        #     payload, val_ids_suf,
        #     feature_families=feature_families,
        #     connectivity_metric=connectivity_metric,
        #     connectivity_band=connectivity_band,
        # )
        # test_graphs = payload_to_graphs(
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(root_path,'CAUEEG/result_MIL-LinkX-slidingwindow')
    ...
    parser.add_argument(
        ...
        choices=["gnn", 'hybrid', 'gat', "LINKX", "linkx_cnn", "cnn5","linkx_cnn5", "mlp_node", "sage", "gcn2", "h2gcn"]
