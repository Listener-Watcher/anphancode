...
def run_caueeg_linkx_mil(
    ...
    run_name = f"{timestamp}_{task}_linkxmil_{connectivity_metric}_k{base_k}_{encoder_type}_{mil_pool_type}_{filter_method}_seed{seed}"
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(root_path,'CAUEEG/result_MIL-LinkX-update-correctchannel')
    ...
    for seed in [15, 100, 555]:
        out = run_caueeg_linkx_mil(
            ...
            task="dementia",
            file_format="feather",
            # out_h5="/mnt/data/anphan/CAUEEG/caueeg_master_linkx_wpli.h5",
